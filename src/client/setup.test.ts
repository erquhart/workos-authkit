...
import { type WorkOSAuthKitComponent } from "./index.js";
...
>(schema?: Schema) {
  ...
  t.registerComponent("workOSAuthKit", componentSchema, componentModules);
  return t;
}
export const components = componentsGeneric() as unknown as {
  workOSAuthKit: WorkOSAuthKitComponent;
};
